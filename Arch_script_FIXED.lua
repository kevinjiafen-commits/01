...
-- Config UI sync registry: maps S-key -> Set(value) function
local UIRegistry = {}
local function RegisterUI(skey, setFn)
    if skey and setFn then UIRegistry[skey] = setFn end
end
...
function Library:Tab(name, icon)
    ...
    function GroupFunctions:Group(title)
        ...
        function ItemFuncs:Toggle(cfg)
            ...
            local ctrl = {Set = function(v) if v ~= Enabled then Update() end end}
            if cfg.SKey then RegisterUI(cfg.SKey, ctrl.Set) end
            return ctrl
        end
        ...
        function ItemFuncs:Slider(cfg)
            ...
            local function SetSlider(v)
                v = math.clamp(roundValue(v), cfg.Min, cfg.Max)
                Value = v
                local pct = (v - cfg.Min) / (cfg.Max - cfg.Min)
                Fill.Size = UDim2.new(pct, 0, 1, 0)
                ValueLabel.Text = formatValue(v) .. (cfg.Unit or "")
                if cfg.Callback then cfg.Callback(v) end
            end
            if cfg.SKey then RegisterUI(cfg.SKey, SetSlider) end
        end
        ...
        function ItemFuncs:Dropdown(cfg)
            ...
            if cfg.SKey then RegisterUI(cfg.SKey, SetDropdown) end
        end
        ...
        function ItemFuncs:ColorPicker(cfg)
            ...
            if cfg.Tooltip then AddTooltip(Frame, cfg.Tooltip) end
            local function SetColorPicker(c)
            ...
            if cfg.SKey then RegisterUI(cfg.SKey, SetColorPicker) end
        end
        ...
        function ItemFuncs:Keybind(cfg)
            ...
            if cfg.SKey then RegisterUI(cfg.SKey, SetKeybind) end
        end
...
AimGroup:Toggle({Name = "Enabled", Tooltip = "Legit aimbot", SKey = "aimbotActive", Callback = function(v) toggleAimbot(v) end})
AimGroup:Slider({Name = "FOV", Min = 5, Max = 180, Default = 30, Unit = "°", SKey = "aimFov", Callback = function(v) S.aimFov = v end})
AimGroup:Slider({
    Name = "Smoothness",
    Min = 0.1,
    Max = 10,
...
AimGroup:Dropdown({Name = "Target Part", Options = {"Head", "HumanoidRootPart"}, Default = "Head", SKey = "aimTargetPart", Callback = function(v) S.aimTargetPart = v end})
AimGroup:Toggle({Name = "Team Check", SKey = "teamCheck", Callback = function(v) S.teamCheck = v end})
AimGroup:ColorPicker({Name = "FOV Color", Default = Color3.new(1,1,1), Tooltip = "Aimbot FOV circle color", SKey = "aimFovColor", Callback = function(c) S.aimFovColor = c end})

local TriggerGroup = Legit:Group("Triggerbot")
TriggerGroup:Toggle({Name = "Enabled", SKey = "triggerbotEnabled", Callback = function(v) toggleTriggerbot(v) end})
TriggerGroup:Keybind({Name = "Key", Default = Enum.KeyCode.T, SKey = "triggerbotKey", Callback = function(k) S.triggerbotKey = k end})
TriggerGroup:Slider({Name = "Delay", Min = 0, Max = 200, Default = 50, Unit = "ms", SKey = "triggerbotDelay", Callback = function(v) S.triggerbotDelay = v end})
TriggerGroup:Toggle({Name = "Wall Check", SKey = "triggerbotWallCheck", Callback = function(v) S.triggerbotWallCheck = v end})
TriggerGroup:Toggle({Name = "Team Check", SKey = "triggerbotTeamCheck", Callback = function(v) S.triggerbotTeamCheck = v end})
TriggerGroup:Toggle({Name = "Only ADS", Tooltip = "Only fire when aiming", SKey = "triggerbotOnlyADS", Callback = function(v) S.triggerbotOnlyADS = v end})
...
SilentGroup:Toggle({Name = "Enabled", SKey = "silentAimActive", Callback = function(v) toggleSilentAim(v) end})
SilentGroup:Slider({Name = "FOV", Min = 5, Max = 180, Default = 30, Unit = "°", SKey = "silentFov", Callback = function(v) S.silentFov = v end})
SilentGroup:Dropdown({Name = "Target Part", Options = {"Head", "HumanoidRootPart"}, Default = "Head", SKey = "silentTargetPart", Callback = function(v) S.silentTargetPart = v end})
SilentGroup:ColorPicker({Name = "FOV Color", Default = Color3.new(1,0,0), Tooltip = "Silent Aim FOV circle color", SKey = "silentFovColor", Callback = function(c) S.silentFovColor = c end})

local FovDispGroup = Legit:Group("FOV Display")
FovDispGroup:Toggle({Name = "Show FOV", Tooltip = "Show/Hide all FOV circles", SKey = "showFovCircles", Callback = function(v) S.showFovCircles = v end})
FovDispGroup:Dropdown({Name = "Style", Options = {"Outline", "Filled"}, Default = "Outline", SKey = "fovStyle", Callback = function(v) S.fovStyle = v end})

local MovementGroup = Rage:Group("Movement")
MovementGroup:Toggle({Name = "Void", SKey = "voidActive", Callback = function(v) toggleVoid(v) end})
MovementGroup:Toggle({Name = "Orbit", SKey = "orbActive", Callback = function(v) toggleOrbit(v) end})
MovementGroup:Toggle({Name = "Noclip", SKey = "noclipActive", Callback = function(v) toggleNoclip(v) end})
MovementGroup:Toggle({Name = "Fly", SKey = "flyActive", Callback = function(v) toggleFly(v) end})
MovementGroup:Slider({Name = "Fly Speed", Min = 16, Max = 200, Default = 50, Unit = " studs", SKey = "flySpeed", Callback = function(v) S.flySpeed = v; if S.flyActive then toggleFly(true) end end})
MovementGroup:Toggle({Name = "SpinBot", SKey = "spinActive", Callback = function(v) toggleSpin(v) end})
MovementGroup:Slider({Name = "Spin Speed", Min = 1, Max = 50, Default = 10, Unit = "", SKey = "spinSpeed", Callback = function(v) S.spinSpeed = v end})
...
MovementGroup:Toggle({Name = "NoFall", SKey = "noFallActive", Callback = function(v) toggleNoFall(v) end})

local CombatGroup = Rage:Group("Combat")
CombatGroup:Toggle({Name = "Fist", SKey = "fistActive", Callback = function(v) toggleFist(v) end})
CombatGroup:Toggle({Name = "Riot", SKey = "roitActive", Callback = function(v) toggleRiot(v) end})
CombatGroup:Toggle({Name = "Scythe", SKey = "scytheActive", Callback = function(v) toggleScythe(v) end})
CombatGroup:Toggle({Name = "Wallbang", SKey = "wallbangActive", Callback = function(v) toggleWallbang(v) end})
CombatGroup:Toggle({Name = "Wallbang Head", SKey = "wallbangHeadActive", Callback = function(v) toggleWallbangHead(v) end})
...
ESPGroup:Toggle({Name = "Enabled", SKey = "espActive", Callback = function(v) toggleESP(v) end})
ESPGroup:Toggle({Name = "Box", SKey = "espShowBox", Callback = function(v) S.espShowBox = v end})
ESPGroup:Dropdown({Name = "Box Type", Options = {"2D", "Corner", "Filled"}, Default = "2D", SKey = "espBoxType", Callback = function(v) S.espBoxType = v end})
ESPGroup:Toggle({Name = "Tracers", SKey = "espShowTracers", Callback = function(v) S.espShowTracers = v end})
ESPGroup:Toggle({Name = "Name", SKey = "espShowName", Callback = function(v) S.espShowName = v end})
ESPGroup:Toggle({Name = "Distance", SKey = "espShowDistance", Callback = function(v) S.espShowDistance = v end})
ESPGroup:Toggle({Name = "Health Bar", SKey = "espShowHealthBar", Callback = function(v) S.espShowHealthBar = v end})
ESPGroup:Toggle({Name = "Skeleton", SKey = "espShowSkeleton", Callback = function(v) S.espShowSkeleton = v end})

local PlayerGroup = Misc:Group("Player")
PlayerGroup:Slider({Name = "Speed", Min = 16, Max = 500, Default = 16, Unit = " studs", SKey = "speedValue", Callback = function(v) setSpeed(v) end})
PlayerGroup:Toggle({Name = "Infinite Jump", SKey = "infiniteJumpActive", Callback = function(v) S.infiniteJumpActive = v end})
...
WeaponGroup:Toggle({Name = "Rapid Fire", SKey = "rapidFireActive", Callback = function(v) toggleRapidFire(v) end})
WeaponGroup:Slider({Name = "Delay (ms)", Min = 1, Max = 200, Default = 1, Unit = "ms", SKey = "fireDelay", Callback = function(v) S.fireDelay = v; if S.rapidFireActive then applyRapidFire() end end})
WeaponGroup:Toggle({Name = "Instant ADS", SKey = "instantAdsEnabled", Callback = function(v) S.instantAdsEnabled = v; applyGunEnhancements() end})
WeaponGroup:Toggle({Name = "No Equip Anim", SKey = "noEquipAnimEnabled", Callback = function(v) S.noEquipAnimEnabled = v; applyGunEnhancements() end})
WeaponGroup:Toggle({Name = "No Shoot Anim", SKey = "noShootAnimEnabled", Callback = function(v) S.noShootAnimEnabled = v; applyGunEnhancements() end})
WeaponGroup:Toggle({Name = "No Spread", SKey = "noSpreadEnabled", Callback = function(v) S.noSpreadEnabled = v; patchGunSpread() end})
WeaponGroup:Toggle({Name = "No Smoke", SKey = "noSmokeEnabled", Callback = function(v) S.noSmokeEnabled = v; applyNoSmoke() end})
WeaponGroup:Toggle({Name = "No Flash", SKey = "noFlashEnabled", Callback = function(v) S.noFlashEnabled = v; applyNoFlash() end})

local DeviceGroup = Misc:Group("Device Spoof")
DeviceGroup:Toggle({Name = "Enabled", SKey = "deviceSpoofEnabled", Callback = function(v) S.deviceSpoofEnabled = v; applyDeviceSpoof() end})
DeviceGroup:Dropdown({Name = "Spoof As", Options = {"VR", "Touch", "Gamepad"}, Default = "VR", SKey = "spoofDevice", Callback = function(v) S.spoofDevice = v; if S.deviceSpoofEnabled then applyDeviceSpoof() end end})
...
local function loadConfig(silent)
    ...
    -- Sync all registered UI controls to the freshly-loaded S values
    for skey, setFn in pairs(UIRegistry) do
        pcall(function()
            local val = S[skey]
            if val ~= nil then setFn(val) end
        end)
    end
